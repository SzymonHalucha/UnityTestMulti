...
{
    private readonly List<TypeEventListener3<T1, T2, T3>> typedListeners = new();
    private readonly List<Action<T1, T2, T3>> typedActions = new();

    private List<TypeEventListener3<T1, T2, T3>> temporaryTypedListeners = new();
    private List<Action<T1, T2, T3>> temporaryTypedActions = new();
